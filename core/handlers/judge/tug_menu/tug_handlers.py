...
async def back_tug_start_match_handler(call: CallbackQuery, button: Button, dialog_manager: DialogManager):
    await dialog_manager.switch_to(TugStates.match)
    await call.answer('Назад!')
...
async def back_tug_process_handler(call: CallbackQuery, button: Button, dialog_manager: DialogManager):
    await dialog_manager.switch_to(TugStates.match)
    await call.message.answer('Назад!')
