...
def get_tug_start_match_window() -> Window:
    return Window(
        ...
        Button(Const('Назад'), id='back_start_tug_match', on_click=back_tug_start_match_handler),
...
def get_tug_process_window() -> Window:
    return Window(
        ...
        Button(Const("Назад"), id="back_tug_process_set", on_click=back_tug_process_handler),
