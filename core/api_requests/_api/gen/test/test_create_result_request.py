...
class TestCreateResultRequest(unittest.TestCase):
    """CreateResultRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateResultRequest:
        """Test CreateResultRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateResultRequest`
        """
    ...
    def testCreateResultRequest(self):
        """Test CreateResultRequest"""
