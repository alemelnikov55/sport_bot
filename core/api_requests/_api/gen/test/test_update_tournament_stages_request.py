...
class TestUpdateTournamentStagesRequest(unittest.TestCase):
    """UpdateTournamentStagesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTournamentStagesRequest:
        """Test UpdateTournamentStagesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTournamentStagesRequest`
        """
        model = UpdateTournamentStagesRequest()
        if include_optional:
            return UpdateTournamentStagesRequest(
                discipline_id = '',
                tournament = [
                    openapi_client.models.tournament_stages_inner.TournamentStages_inner(
                        stage = '', 
                        competitions = [
                            openapi_client.models.competition.Competition(
                                ...
                                status = '', 
                                participants = [
                                    openapi_client.models.competition_participants_inner.Competition_participants_inner(
                                        division_id = '', )
                                    ], )
                            ], )
                    ]
    ...
    def testUpdateTournamentStagesRequest(self):
        """Test UpdateTournamentStagesRequest"""
