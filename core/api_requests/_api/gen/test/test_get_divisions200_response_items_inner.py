...
class TestGetDivisions200ResponseItemsInner(unittest.TestCase):
    """GetDivisions200ResponseItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDivisions200ResponseItemsInner:
        """Test GetDivisions200ResponseItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDivisions200ResponseItemsInner`
        """
        model = GetDivisions200ResponseItemsInner()
        if include_optional:
            return GetDivisions200ResponseItemsInner(
                id = '',
                name = ''
            )
        else:
    ...
    def testGetDivisions200ResponseItemsInner(self):
        """Test GetDivisions200ResponseItemsInner"""
