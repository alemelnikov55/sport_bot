...
class TestCompetitionParticipantsInner(unittest.TestCase):
    """CompetitionParticipantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompetitionParticipantsInner:
        """Test CompetitionParticipantsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompetitionParticipantsInner`
        """
        model = CompetitionParticipantsInner()
        if include_optional:
            return CompetitionParticipantsInner(
                division_id = ''
            )
        else:
            return CompetitionParticipantsInner(
    ...
    def testCompetitionParticipantsInner(self):
        """Test CompetitionParticipantsInner"""
