...
class TestGetDivisions200Response(unittest.TestCase):
    """GetDivisions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDivisions200Response:
        """Test GetDivisions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDivisions200Response`
        """
        model = GetDivisions200Response()
        if include_optional:
            return GetDivisions200Response(
                items = [
                    openapi_client.models.get_divisions_200_response_items_inner.getDivisions_200_response_items_inner(
                        id = '', 
                        name = '', )
                    ]
            )
    ...
    def testGetDivisions200Response(self):
        """Test GetDivisions200Response"""
