...
class TestTournamentStagesInner(unittest.TestCase):
    """TournamentStagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TournamentStagesInner:
        """Test TournamentStagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TournamentStagesInner`
        """
        model = TournamentStagesInner()
        if include_optional:
            return TournamentStagesInner(
                stage = '',
                competitions = [
    ...
    def testTournamentStagesInner(self):
        """Test TournamentStagesInner"""
