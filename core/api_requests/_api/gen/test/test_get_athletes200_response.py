...
class TestGetAthletes200Response(unittest.TestCase):
    """GetAthletes200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAthletes200Response:
        """Test GetAthletes200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAthletes200Response`
        """
        model = GetAthletes200Response()
        if include_optional:
            return GetAthletes200Response(
                items = [
                    openapi_client.models.get_athletes_200_response_items_inner.getAthletes_200_response_items_inner(
                        id = 1, 
                        first_name = '', 
                        last_name = '', 
                        middle_name = '', 
                        birth_date = 'Thu Jan 01 03:00:00 MSK 1970', 
                        weight = 1.337, 
                        gender = 'male', 
                        division_id = '', 
                        disciplines = [
    ...
    def testGetAthletes200Response(self):
        """Test GetAthletes200Response"""
