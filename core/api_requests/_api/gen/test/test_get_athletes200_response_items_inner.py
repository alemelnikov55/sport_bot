...
class TestGetAthletes200ResponseItemsInner(unittest.TestCase):
    """GetAthletes200ResponseItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAthletes200ResponseItemsInner:
        """Test GetAthletes200ResponseItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAthletes200ResponseItemsInner`
        """
        model = GetAthletes200ResponseItemsInner()
        if include_optional:
            return GetAthletes200ResponseItemsInner(
                id = 1,
                first_name = '',
                last_name = '',
                middle_name = '',
    ...
    def testGetAthletes200ResponseItemsInner(self):
        """Test GetAthletes200ResponseItemsInner"""
