...
class GetAthletes200ResponseItemsInner(BaseModel):
    """
    GetAthletes200ResponseItemsInner
    """ # noqa: E501
    id: StrictInt
    first_name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, alias="firstName")
    last_name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, alias="lastName")
    middle_name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, alias="middleName")
    birth_date: Optional[date] = Field(default=None, description="Дата рождения, формат даты ISO. Обязательно для спортсмена. Используется для вычисления возрастной категории", alias="birthDate")
    weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Вес в кг. Обязательно для спортсмена. Используется для вычисления весовой категории")
    gender: Optional[StrictStr] = Field(default=None, description="Пол. Обязательно для спортсмена")
    division_id: Optional[StrictStr] = Field(default=None, alias="divisionId")
    disciplines: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "middleName", "birthDate", "weight", "gender", "divisionId", "disciplines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "disciplines": obj.get("disciplines")
        })
        return _obj
