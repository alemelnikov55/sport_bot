...
class CompetitionParticipantsInner(BaseModel):
    """
    CompetitionParticipantsInner
    """ # noqa: E501
    division_id: Optional[StrictStr] = Field(default=None, description="Идентификатор филиала", alias="divisionId")
    __properties: ClassVar[List[str]] = ["divisionId"]
