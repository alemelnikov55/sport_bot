...
class Athlete(BaseModel):
    ...
    Athlete
    """ # noqa: E501
    id: Annotated[int, Field(strict=True, ge=1)] = Field(description="Идентификатор аккаунта")
    first_name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="Имя", alias="firstName")
    last_name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="Фамилия", alias="lastName")
    middle_name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="Отчество", alias="middleName")
    division_id: StrictStr = Field(description="Идентификатор филиала", alias="divisionId")
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "middleName", "divisionId"]
