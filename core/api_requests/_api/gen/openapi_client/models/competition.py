...
class Competition(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Идентификатор соревнования")
    status: StrictStr = Field(description="Статус результатов по соревнованию: - planned - запланировано, но состав ещё не определён - upcoming - соревнование ожидает начала - ongoing - соревнование идёт - ended - соревнование завершено ")
    participants: Annotated[List[CompetitionParticipantsInner], Field(min_length=2, max_length=2)]
    __properties: ClassVar[List[str]] = ["id", "status", "participants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participants": [CompetitionParticipantsInner.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None
        })
        return _obj
