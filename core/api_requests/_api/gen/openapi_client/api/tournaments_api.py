...
class TournamentsApi:
    ...
    @validate_call
    def update_tournament_stages(
        self,
        update_tournament_stages_request: UpdateTournamentStagesRequest,
        ...
        :param update_tournament_stages_request: (required)
        :type update_tournament_stages_request: UpdateTournamentStagesRequest
        ...
        _param = self._update_tournament_stages_serialize(
            update_tournament_stages_request=update_tournament_stages_request,
    ...
    @validate_call
    def update_tournament_stages_with_http_info(
        self,
        update_tournament_stages_request: UpdateTournamentStagesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_tournament_stages_without_preload_content(
        self,
        update_tournament_stages_request: UpdateTournamentStagesRequest,
        _request_timeout: Union[
            None,
    ...
    def _update_tournament_stages_serialize(
        self,
        update_tournament_stages_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if update_tournament_stages_request is not None:
            _body_params = update_tournament_stages_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/referee-integration/api/v1/tournaments',
