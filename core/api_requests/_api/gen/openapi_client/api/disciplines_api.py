...
class DisciplinesApi:
    ...
    def get_disciplines(
        ...
        _param = self._get_disciplines_serialize(
    ...
    @validate_call
    def get_disciplines_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDisciplines200Response]:
        """Получение списка спортивных дисциплин
    ...
    @validate_call
    def get_disciplines_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_disciplines_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/referee-integration/api/v1/disciplines',
